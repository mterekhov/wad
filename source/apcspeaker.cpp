...
APCSpeaker::APCSpeaker(const ALump& lump) : ALump(lump.alSize(), lump.alOffset(), lump.alName(), LUMPTYPES_FLATS),
                                    m_pData(0)
{
...
bool APCSpeaker::apReadData(APalete& palete, FILE* wadFile)
{
